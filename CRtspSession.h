...
private:
    ...
    u_short        m_ClientRTPPort;                           // client port for UDP based RTP transport for video
    u_short        m_ClientRTCPPort;                          // client port for UDP based RTCP transport for video

    u_short        m_ClientAudioRTPPort;                           // client port for UDP based RTP transport for audio
    u_short        m_ClientAudioRTCPPort;                          // client port for UDP based RTCP transport for audio
